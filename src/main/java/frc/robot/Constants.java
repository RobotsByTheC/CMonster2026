...
public class Constants {
  ...
  public static class IntakeConstants {
    ...
    public static final AngularVelocity MAX_WRIST_SPEED = RadiansPerSecond.of(2);
    public static final AngularAcceleration MAX_WRIST_ACCELERATION = RadiansPerSecondPerSecond.of(1);

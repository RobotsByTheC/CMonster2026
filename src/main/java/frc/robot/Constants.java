...
public class Constants {
  ...
  public static class ShooterConstants {
    ...
    public static class FlywheelConstants {
      ...
      public static final AngularVelocity IDLE_SPEED = RPM.of(600);
  ...
  public static class VisionConstants {
    public static final Transform3d FRONT_CAMERA_OFFSET = new Transform3d(0, 0, 0, Rotation3d.kZero);
    public static final Transform3d REAR_CAMERA_OFFSET = new Transform3d(0, 0, 0, Rotation3d.kZero);

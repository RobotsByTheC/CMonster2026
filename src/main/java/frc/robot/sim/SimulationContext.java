...
public class SimulationContext {
   ...
   * in this context and update the robot's battery voltage to account for the voltage drop caused by the currents drawn
   * by all the mechanisms. The voltage can be read via {@link RobotController#getBatteryVoltage()} or from a mechanism
   * simulation's {@link MechanismSim#getBatteryVoltage()} convenience method.
   *
   * @param timestep

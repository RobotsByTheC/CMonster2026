...
public interface IntakeIO {
  ...
  /**
   * Sets the voltage of the wrist controlling the intake. Positive voltage is clockwise (extending the intake), negative
   * values are counterclockwise (retracting the intake).
   *
   * @param voltage

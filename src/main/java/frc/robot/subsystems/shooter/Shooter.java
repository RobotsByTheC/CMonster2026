...
public class Shooter extends SubsystemBase {
	...
	public Shooter(boolean real) {
		if (real) {
			...
			// rightFlywheel = new Flywheel(new RealFlywheelIO(true,
			// FLYWHEEL_RIGHT_A_CAN_ID, FLYWHEEL_RIGHT_B_CAN_ID));
	...
	public Command f_idle() {
		...
		// .alongWith(rightFlywheel.f_shoot(() ->
		// Constants.ShooterConstants.FlywheelConstants.IDLE_SPEED))
